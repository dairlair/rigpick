 ...
 */
class Version20180123065421 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE vendor (id INT NOT NULL, pci_sig_id INT DEFAULT NULL, name TEXT NOT NULL, brand TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F52233F61C52F958 ON vendor (brand)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE graphic_card_models DROP CONSTRAINT FK_B3A750F6F603EE73');
        $this->addSql('ALTER TABLE graphic_card_series DROP CONSTRAINT FK_6D6161D2F603EE73');
